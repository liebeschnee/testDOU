...
/**
 * Day1 Step19 Gmail (5min)
 *
 * <p>来源: Scenario(Phone) 表 Day1 Step19 Gmail
 * <br>说明: 深度控件操作，Read email
 */
@LargeTest
public class dou_day_1_19 extends UiAutoTestCase {

    private static final String TAG = "dou_day_1_19";
